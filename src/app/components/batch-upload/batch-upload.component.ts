  ...
  template: `
    <div class="batch-page">
      <div class="page-header fade-in-up">
        ...
        <p class="page-sub">
          Upload a CSV file with multiple resumes or add them manually. Results
          exportable as CSV.
        </p>
      </div>
      ...
      <div class="batch-layout">
        ...
        <div class="upload-panel fade-in-up" style="animation-delay:0.1s">
          ...
          >
            ...
            >
              ...
              <div class="fb-text">
                ...
                <p class="f-meta">
                  {{ resumeInputs.length }} resume{{
                    resumeInputs.length !== 1 ? 's' : ''
                  }}
                  parsed
                </p>
              </div>
          ...
          <div class="manual-area">
            <div class="field-group">
              ...
              <textarea
                ...
                placeholder="Python, Django, PostgreSQL, Docker, REST APIs..."
              ></textarea>
            </div>
            ...
            <div class="field-group">
              ...
              <textarea
                ...
                rows="2"
                [(ngModel)]="manualEdu"
                placeholder="B.Tech. Computer Science, VIT University (2018–2022) | GPA 3.7"
              ></textarea>
            </div>
          ...
          <div class="queue-list" *ngIf="resumeInputs.length">
            ...
            <div
              class="queue-item"
              *ngFor="let r of resumeInputs; let i = index"
            >
              <span class="qi-num">#{{ i + 1 }}</span>
              <div class="qi-info">
                <span class="qi-skills"
                  >{{ r.skills.slice(0, 45)
                  }}{{ r.skills.length > 45 ? '…' : '' }}</span
                >
                <span class="qi-meta">
                  {{
                    r.experience
                      ? r.experience.slice(0, 30) + '…'
                      : 'No experience'
                  }}
        ...
        <div class="results-panel fade-in-up" style="animation-delay:0.15s">
          ...
          <div class="results-header" *ngIf="results.length && !loading">
            ...
            <div class="summary-pills">
              ...
              <span class="pill yellow"
                >⚠ {{ summary.suspicious }} Suspicious</span
              >
          ...
          <div class="batch-empty" *ngIf="!results.length && !loading">
            ...
            <p class="empty-sub">
              Upload a CSV or add resumes manually, then click Run.
            </p>
          </div>
          ...
          <div class="progress-wrap" *ngIf="loading">
            <div class="prog-track">
              <div
                ...
                [style.width.%]="
                  resumeInputs.length
                    ? (processed / resumeInputs.length) * 100
                    : 0
                "
              ></div>
            </div>
            <p class="prog-text">
              Assessed {{ processed }} of {{ resumeInputs.length }} resumes...
            </p>
          </div>
          ...
          <div class="result-rows" *ngIf="results.length">
            ...
            >
              ...
              <div class="rr-verdict">
                ...
                <span class="rr-conf"
                  >{{ (r.confidence_score * 100).toFixed(0) }}% conf</span
                >
              </div>
              ...
              <div class="rr-signals">
                <span
                  class="sig-pill"
                  [ngClass]="
                    r.signal_breakdown.timeline_validation.timeline_overlap
                      ? 'bad'
                      : 'ok'
                  "
                >
                ...
                <span
                  class="sig-pill"
                  [ngClass]="
                    r.signal_breakdown.evidence_verification.has_projects
                      ? 'ok'
                      : 'warn'
                  "
                >
                ...
                <span
                  class="sig-pill"
                  [ngClass]="
                    r.signal_breakdown.timeline_validation.future_grad_year
                      ? 'bad'
                      : 'ok'
                  "
                >
                ...
                >
                  ...
                  <div class="rr-bar-track">
                    <div
                      class="rr-bar-fill"
                      [ngClass]="'fill-' + cls"
                      [style.width.%]="getScore(r, cls) * 100"
                    ></div>
                  </div>
                  <span class="rr-bar-pct"
                    >{{ (getScore(r, cls) * 100).toFixed(0) }}%</span
                  >
                </div>
              </div>
            </div>
    ...
    `
      ...
      .cf-textarea {
        ...
        &:focus {
          outline: none;
          border-color: var(--orange);
          box-shadow: 0 0 0 3px rgba(255, 107, 26, 0.09);
        }
        &::placeholder {
          color: var(--text-muted);
        }
...
export class BatchUploadComponent {
  ...
  parseCSV(text: string) {
    ...
    if (lines.length < 2) {
      this.csvError =
        'CSV file is empty or has only a header row. Add at least one data row.';
      this.file = null;
      return;
    }
    ...
    if (parsed.length === 0) {
      this.csvError =
        'No valid data rows found. Make sure the CSV has data rows below the header.';
      this.file = null;
      return;
    }
  ...
  addManual() {
    ...
    if (!this.manualSkills.trim() && !this.manualExp.trim()) {
      this.manualError =
        'Please provide at least Skills or Experience before adding to queue.';
      return;
    }
      ...
      await new Promise<void>((resolve) => {
        this.api.assessResume(resume).subscribe({
          next: (r) => {
            ...
            this.processed++;
            const key =
              r.credibility_label.toLowerCase() as keyof typeof this.summary;
  ...
  exportCsv() {
    ...
    const headers =
      'Resume ID,Label,Confidence (%),Credible (%),Suspicious (%),False (%),Timeline Overlap,Future Grad,Has Projects,Skill Count,Buzzwords';
